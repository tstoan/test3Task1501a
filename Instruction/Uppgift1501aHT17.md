...
Instruktioner - uppgift 1501a
======
_Ulrik Eklund, 2015-11-11_
_Tommy Andersson, 2017-10-13_
...
1. Om annan dator än labbsalens dator används (t.ex. egen dator) måste följande program finnas installerat på den datorn:
    ...
    2. Bossac flashprogrammeringsdriver, inklusive DOS-macro (finns när du laddat ner uppgiftens repo från Github)
